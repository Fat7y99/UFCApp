...
import { useFontFamily } from './FontContext';
 ...
 * and determines the default theme based on the color scheme and selected font family.
 *
...
const useAppTheme = () => {
  ...
  // Define fonts with selected font family.
  const fonts = useAppThemeFonts(fontFamily);
