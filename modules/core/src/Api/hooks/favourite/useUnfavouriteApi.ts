...
const useUnfavouriteApi = (
  options?: Omit<
    UseMutationOptions<FavouriteResponse, ServerError, ApiRequest<void, number>>,
    'mutationFn'
  >,
) => {
  ...
  >({
    mutationFn: request => queryFavourite.unfavourite(request),
...
export default useUnfavouriteApi;
