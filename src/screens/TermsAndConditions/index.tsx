      ...
      >
        <View style={styles.contentCard}>
          ...
          <Text style={[styles.headingText, isRTL && { textAlign: 'left' }]}>
            {translate(`${TranslationNamespaces.SETTINGS}:termsHeading`)}
          </Text>

          {/* Body Text */}
          <Text style={[styles.bodyText, isRTL && { textAlign: 'left' }]}>
            {translate(`${TranslationNamespaces.SETTINGS}:termsContent`)}
          </Text>
          ...
          <View style={styles.bulletList}>
            <View style={styles.bulletItem}>
              ...
              <Text style={[styles.bodyText, isRTL && { textAlign: 'left' }]}>
                {translate(`${TranslationNamespaces.SETTINGS}:termsBullet1`)}
              </Text>
            </View>
            <View style={styles.bulletItem}>
              <Text style={styles.bullet}>•</Text>
              <Text style={[styles.bodyText, isRTL && { textAlign: 'left' }]}>
                {translate(`${TranslationNamespaces.SETTINGS}:termsBullet2`)}
              </Text>
            </View>
            <View style={styles.bulletItem}>
              <Text style={styles.bullet}>•</Text>
              <Text style={[styles.bodyText, isRTL && { textAlign: 'left' }]}>
                {translate(`${TranslationNamespaces.SETTINGS}:termsBullet3`)}
              </Text>
            </View>
            <View style={styles.bulletItem}>
              <Text style={styles.bullet}>•</Text>
              <Text style={[styles.bodyText, isRTL && { textAlign: 'left' }]}>
                {translate(`${TranslationNamespaces.SETTINGS}:termsBullet4`)}
              </Text>
            </View>
          </View>
        </View>
